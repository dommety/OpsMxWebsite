    ...
    <div className="min-h-screen bg-navy-950 text-white overflow-x-hidden">
      ...
      <section className="relative py-24 overflow-hidden border-t border-white/5">
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          >
            <a href="/request-a-demo" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-2 px-8 py-4 rounded-xl font-semibold text-white bg-gradient-to-r from-cyan-500 to-electric-500 hover:from-cyan-400 hover:to-electric-400 transition-all shadow-xl shadow-cyan-500/25 text-lg">
              Request a Demo
